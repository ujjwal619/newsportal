	...
	<div id="loginbox" style="margin-top: 50px;"
		...
		<div class="panel panel-info">
			...
			<div style="padding-top: 30px" class="panel-body">
				...
				<form method="post" id="loginform" class="form-horizontal" action="http://localhost:8080/newsportal/login/create"
					role="form">
					...
					<div class="form-group">
						<div class="col-md-12 control">
							<div
								...
								Don't have an account! <a href="http://localhost:8080/newsportal/news/signup"
